	...
	String^ molecular_weight;
		...
		try {
			if (buffer_formula != chemical_formula_textBox->Text) {
				...
				molecular_weight = gcnew String(ConvertToMolecularWeight(chemical_formula_textBox->Text));

				buffer_molecular_weight = molecular_weight;

				result_mass_calculation_textBox->Text = Mass(molecular_weight, 
...
System::Void ChemicalCalculator::ChemicalCalculatorForm::calculat_volume_calculation_button_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try {
		if (buffer_formula != chemical_formula_textBox->Text) {
			...
			result_volume_calculation_textBox->Text = Volume(molecular_weight, 
...
System::Void ChemicalCalculator::ChemicalCalculatorForm::calculat_molar_concentration_calculation_button_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try {
		if (buffer_formula != chemical_formula_textBox->Text) {
			...
			result_molar_concentration_textBox->Text = MolarConcentration(molecular_weight, 
