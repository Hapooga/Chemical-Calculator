...
public:
	...
	static PeriodicTable& Instence() {
		static PeriodicTable periodic_table;
		return periodic_table;
	}

	const float GetAtomicWeightFromClass(const std::string element) const {
...
private:
	...
	const std::map<std::string, float> periodic_table{
